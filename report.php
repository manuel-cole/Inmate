                 ...
                 <div class=" profile span12">
                     ...
                     <div class="span11">
                         ...
                         <div class="row-fluid">
                             <div class="span12 bio form">
                                 ...
                                 <form class="form-horizontal" method="POST" name="add" action="update.php">
                    ...
                    <td><input style="width: 60px" type="text" class="form-control" name="Nabout" placeholder="<?php echo $row['about'];?>" value="<?php echo $row['about']?>" /></td>
                                  ...
                                  <div class="text-center">
                                     <button type="submit" name="update" href="update.php" class="btn btn-inverse btn-large " onclick="myFunction()">Print Out</button>
                                 </div>
                                 </form>
                                         <!-- END FORM-->
